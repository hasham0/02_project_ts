...
async function login() {
    ...
    if (options.userOptions === "check balance") {
        ...
        console.log(`your total money in this account is ${user[check].totalAmount}`);
    }
    // performing deposite amount
        ...
        console.log(`your total money in this account after depoite ${insertAmount.deposite} is ${user[0].totalAmount}`);
    }
    // performing withdraw balance
        ...
        console.log(`your total money in this account after withdraw ${withdrawAmount.withdraw} is ${user[check].totalAmount}`);
    }
